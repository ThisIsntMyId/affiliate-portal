  ...
  const demoSections = [
    {
      ...
      icon: FileText,
      href: '/demo/forms',
      features: ['12+ input types', 'Create/Edit patterns', 'File uploads', 'Error handling']
    },
    {
      title: 'Tables',
      ...
      icon: Table,
      href: '/demo/table',
      features: ['Sortable columns', 'Advanced filtering', 'Custom actions', 'URL state management']
    },
    {
      title: 'Charts',
      ...
      <div className="text-center mb-12">
        ...
        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 max-w-2xl mx-auto">
          <p className="text-sm text-blue-800 dark:text-blue-200">
            🎯 <strong>Interactive Demos:</strong> Each section contains working examples based on the latest admin patterns and features
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-muted-foreground">
              <li>• Create/Edit form patterns</li>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-muted-foreground">
              ...
              <li>• Custom actions with routing</li>
          ...
          <div className="space-y-2">
            <h3 className="font-medium text-foreground">Auth</h3>
            <ul className="space-y-1 text-muted-foreground">
              <li>• Login form patterns</li>
              <li>• Verification states</li>
